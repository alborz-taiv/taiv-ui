...
export const feedback = [
  ...
  ["fas fa-info-circle", colors.primary[200], "Info"],
  ["fas fa-circle-question", colors.primary[200], "Help"],
  ...
  ["fas fa-copy", colors.primary[200], "Copy to Clipboard"],
...
export const ssoProviders = [[GoogleIcon, "Google"]];
