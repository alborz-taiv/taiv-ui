...
export const AutoComplete = ({ size = 'md', width, fullWidth = false, placeholder = 'Select an option', styles, ...props }: AutoCompleteProps) => {
  ...
  return <MantineAutocomplete w={computedWidth} size={size} styles={style} placeholder={placeholder} maxDropdownHeight={selectedSize.dropdownHeight} {...props} />;
};
