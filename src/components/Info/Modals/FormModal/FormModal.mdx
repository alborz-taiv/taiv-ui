...
Use `confirmDisabled` to disable the confirm button, e.g. until required form fields are filled. This is useful for validation before allowing submission.

<Story of={FormModalStories.ConfirmDisabled} />
